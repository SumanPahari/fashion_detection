...
def main():
    ...
    train_data_set = deepfashion(cfg.data_root_dir,
                                 '/Users/sumanpahari/Documents/Data Science/Thesis/Datasets/Category and Attribute Prediction Benchmark/prepared_2_cat_train.csv',
    ...
    val_data_set = deepfashion(cfg.data_root_dir,
                                 '/Users/sumanpahari/Documents/Data Science/Thesis/Datasets/Category and Attribute Prediction Benchmark/prepared_2_cat_val.csv',
                                 data_transform["val"])
