...
def main():
    ...
    train_data_set = deepfashion(cfg.data_root_dir,
                                 '/Users/sumanpahari/Documents/Data Science/Thesis/Datasets/Category and Attribute Prediction Benchmark/pytorch-faster-rcnn/small_data/prepared_10_cat_train.csv',
    ...
    val_data_set = deepfashion(cfg.data_root_dir,
                               '/Users/sumanpahari/Documents/Data Science/Thesis/Datasets/Category and Attribute Prediction Benchmark/pytorch-faster-rcnn/small_data/prepared_10_cat_val.csv',
                               data_transform["val"])
    ...
    for epoch in range(cfg.start_epoch, cfg.num_epochs):
        loss_dict, total_loss = train_one_epoch(model, optimizer, train_data_loader,
                                                ...
                                                print_freq=cfg.print_freq, warmup=False)
